...
\descript{| Software Engineer, Signals Crawling}
\location{November 2019 - Present | Seattle, WA}
\minigap
\summary{Part of Stripe's Merchant Intelligence org, Signals Crawling is responsible for collecting information about online businesses, enabling customer insights and risk evaluation.}
\minigap
...
\location{March 2017 - October 2019 | Seattle, WA}
\minigap
\summary{Amazon SageMaker is a fully-managed machine learning platform that enables developers and data scientists to build, train, and deploy ML models at scale. The hosting service provides managed HTTPS endpoints, letting users go from ML model Docker containers to production-ready, scalable online inferences in just a few clicks.}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
...
\minigap
\summary{Part of Amazon device middleware services, Mobile Diagnostics enables Amazon devices to record key app performance, usage, and crash information, and securely transmit them to back-end services for troubleshooting and analytics purposes.}
\minigap
\begin{tightemize}
